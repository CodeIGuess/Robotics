...
void autonomous() {
  // THIS AUTON IS NOT SUITABLE FOR MECHA WHEEL BOT 
...
void usercontrol() {
  while (1) {
    ...
    // Arcade Controls
    front_left.spin(fwd, Axis3 - Axis1 + (Axis4), pct);
    back_left.spin(fwd, Axis3 - Axis1 - (Axis4), pct);

    front_right.spin(fwd, Axis3 + Axis1 - (Axis4), pct);
    back_right.spin(fwd, Axis3 + Axis1 + (Axis4), pct);
